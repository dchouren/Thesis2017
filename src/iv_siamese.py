...
from double_siamese import build_variant_model, build_invariant_model
...
def build_iv_siamese_network(input_shape, invariant_model_name='resnet50', invariant_model_weights='imagenet', optimizer='nadam'):

    variant_model = ResNet50(include_top=False, weights=None, input_shape=input_shape)
