...
# #model.load_weights('/scratch/dchouren/resources/weights/imagenet/vgg16_weights.h5', by_name=True)
#
# f = h5py.File('/scratch/dchouren/resources/weights/imagenet/{}_weights.h5'.format('vgg16'))
...
# model.save('/scratch/dchouren/resources/menu/187147/trained_models/old_menu.h5')
