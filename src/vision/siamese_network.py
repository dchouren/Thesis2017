...
# tr_pairs = np.squeeze(np.load('/tigress/dchouren/thesis/resources/pairs/2014/pairs_0.npy'))[:5000]
...
# te_pairs = np.squeeze(np.load('/tigress/dchouren/thesis/resources/pairs/2014/pairs_1.npy'))[:1000]
