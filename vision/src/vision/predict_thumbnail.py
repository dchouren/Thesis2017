...
Production: python src/vision/predict_thumbnail.py vgg16 /spindle/resources/trained_models/thumbnail/top_vgg16_100_55707_dslr.h5 /spindle/dchouren/images/testsets/10022/paris resources/fpaths/geos_10022/paris output/thumbnail/dslr/paris dslr
'''
...
menu_model = load_model('/spindle/resources/trained_models/menu/menu_receipt_classifier.h5')
top_model = load_model(top_model_path)
face_cascade = cv2.CascadeClassifier('/spindle/resources/xml/haarcascade_frontalface_default.xml')
