...
Production: python src/vision/predict_menu.py vgg16 /scratch/resources/trained_models/menu/menu_receipt_classifier.h5 /scratch/dchouren/images/testsets/10022/paris resources/fpaths/geos_10022/paris output/menu/paris menu
'''
